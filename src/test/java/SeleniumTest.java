...
public class SeleniumTest {
    ...
    public void testEqualityCheck() {
        ...
        Assert.assertTrue(result.contains("num is falsy (coercion)"));
    }
    ...
    public void testStrictEqualityCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("num is strictly equal to 0"));
    }
    ...
    public void testInequalityCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("str is falsy (coercion)"));
    }
    ...
    public void testStrictInequalityCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("obj is not null"));
    }
    ...
    public void testLogicalANDCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("At least one is falsy"));
    }
    ...
    public void testLogicalORCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("At least one boolean is true"));
    }
    ...
    public void testNullTruthinessCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("nullUndef is falsy"));
    }
    ...
    public void testUndefinedTruthinessCheck() {
        ...
        clickCheckButton();
        String result = getResultText();
        Assert.assertTrue(result.contains("nullUndef is falsy (negation)"));
    }
